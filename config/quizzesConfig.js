// config/quizzesConfig.js - VERSÃO FINAL

// Importa o objeto 'templates' como um named import.
// Isso é crucial e assume que '../services/templates/templates.js' tem 'export const templates = { ... };'
...
export const quizzesConfig = [
  {
    ...
    // ID numérico da tag "tokmate_lead" no ActiveCampaign (confirmado: 10)
    leadTag: 10, 
    activeCampaignFields: {
      // ATENÇÃO: Estes IDs DEVEM ser os IDs numéricos REAIS dos seus campos personalizados no ActiveCampaign.
      // Verifique-os em 'Contatos > Gerenciar Campos' na sua conta ActiveCampaign.
  ...
  },
  {
    ...
    // ID numérico da tag "primebiome_lead" no ActiveCampaign (confirmado: 11)
    leadTag: 11, 
    activeCampaignFields: {
      scoreFieldId: "4", 
      q4FieldId: "5",
  ...
  },
  {
    ...
    // ID numérico da tag "prodentim_lead" no ActiveCampaign (confirmado: 12)
    leadTag: 12, 
    activeCampaignFields: {
      scoreFieldId: "7", 
      q4FieldId: "8",
  ...
  },
  {
    ...
    // ID numérico da tag "nervovive_lead" no ActiveCampaign (confirmado: 1)
    leadTag: 1, 
    activeCampaignFields: {
      scoreFieldId: "10", 
      q4FieldId: "11",
  ...
  },
  {
    ...
    // ID numérico da tag "totalcontrol24_lead" no ActiveCampaign (confirmado: 15)
    leadTag: 15, 
    activeCampaignFields: {
      scoreFieldId: "13", 
      q4FieldId: "14",
  ...
  },
  {
    ...
    // ID numérico da tag "glucoshield_lead" no ActiveCampaign (confirmado: 13)
    leadTag: 13, 
    activeCampaignFields: {
      scoreFieldId: "16", 
      q4FieldId: "17",
  ...
  },
  {
    ...
    // ID numérico da tag "prostadine_lead" no ActiveCampaign (CONFIRMADO: 14)
    leadTag: 14, 
    activeCampaignFields: {
      scoreFieldId: "19", 
      q4FieldId: "20",
