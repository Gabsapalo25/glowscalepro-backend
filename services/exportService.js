...
async function exportContactsByTag(tagId) {
  const allContacts = [];
  let offset = 0;
  const limit = 100;
...
// ✅ Exportar com os dois nomes para compatibilidade
export { exportContactsByTag, exportContactsByTag as exportLeadsByTag };
